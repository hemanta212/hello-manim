...
class Math1(TeacherStudentsScene, Scene):
  def construct(self):
     ...
     text3 = TextMobject("Probability is a branch of mathematics which deals with the likelihood of an event or circumstance through numbers.")
     ...
     text5 = TextMobject("We use addition, multiplication, and complement rules to calculate probability of an event(s) or an outcome(s). ")
     ...
     text6 = TextMobject("If two events cannot occur at a same time, they are said to be mutually exclusive. ")
     ...
     text7 = TextMobject("Let A and B be two mutually exclusive events. As stated earlier, their probability of occurrence at the same time is 0.")
     ...
     text9 = TextMobject(" 1. Getting multiple(s) of 2 and multiple(s) of 5 after rolling an unbiased dice 2 times respectively. ")
