...
class Example(GraphScene):
    ...
    def answer(self):
        ...
        terms = TexMobject(
                ...
                ).arrange(DOWN, aligned_edge=LEFT).scale(0.8).shift([0,1,0])
        ...
        f4 = TexMobject(
                ...
                "=",
                "Rs. 121,086"
                ).set_color(GREEN).shift([-2.7, -1, 0])
        
        fText = TextMobject("The price will be Rs. 121,086 after 2 years.").shift([0,-2,0])
    ...
    def question(self):
        ...
        t2 = TexMobject("\\text{The present price of a motorcycle is Rs.140000.}","\\text{If it depreciates at } 7\\% \\text{ per year, what will be its price after 2 years?}").scale(0.7).arrange(DOWN, aligned_edge=LEFT)
